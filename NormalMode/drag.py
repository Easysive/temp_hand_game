...
class Drag:
    ...
    def update(self, hand, card_list, ball_handle, surface, lane, hand_tracking,scroll_bar):
        # self.is_draw=False
        # print("drag")
                ...
                if card.move:
                    ...
                    if card.rect.collidepoint((230, 230)):
                        ...
                        if not card.has_used:
                            ...
                            ball_handle.ball_list.add(card.ball)
                            card.has_used = True
                    if not (card.rect.collidepoint((230, 230)) or card.rect.collidepoint(
                            (230, 400)) or card.rect.collidepoint((230, 550))):
                        # 如果没有重叠，将卡片返回到传送带上
